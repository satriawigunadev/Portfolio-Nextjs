...
const ResumeCard = ({ role, Icon, date }: Props) => {
  return (
    <div className="mb-6">
      <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 md:p-8 rounded-md">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-sm sm:text-base pt-3">
            ...
            tempora asperiores voluptas labore magni quia quaerat tempore
            doloribus praesentium. Magnam!
          </p>
        </div>
      </div>
    </div>
