...
function MobileNav({ closeNav, showNav }: Props) {
  ...
  return (
    <div>
      ...
      {/* Navlinks */}
      <div
        className={`text-white fixed ${navOpen} flex justify-center flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-cyan-800 space-y-6 z-[100050] right-0`}
      >
        {NavLinks.map((link) => {
          return (
